...
const Step2Interview = ({ interviewData, onFinish }) => {
          ...
          <div className="lg:col-span-5">
            <div className="rounded-[36px] bg-white/5 border border-white/10 backdrop-blur-2xl p-8 shadow-2xl">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-green-400 text-sm">Live Session ●</div>
              </div>
  ...
  className={`
    ...
    ${isAIPlaying
      ? "bg-green-500/[0.08] shadow-[0_0_60px_rgba(34,197,94,.18)]"
      : "bg-white/5"
    }
  `}
>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-4xl font-bold">Interview Console</h2>
              ...
              {!feedback ? (
                <>
                  <textarea
                    ...
                    className="flex-1 min-h-[320px] rounded-[30px] bg-black/40 border border-white/10 p-7 outline-none resize-none focus:border-green-500/30 text-lg"
                  />

                  <div className="flex items-center gap-5 mt-8">
                    <button
                      onClick={toggleMic}
                      className="w-16 h-16 rounded-full bg-gradient-to-r from-green-400 to-cyan-400 text-black flex items-center justify-center "
                    >
                      {isMicOn ? (
                    ...
                    <button
                      ...
                      className={`flex-1 py-5 rounded-2xl font-semibold text-lg transition-all
                        ${isSubmitting || !answer.trim() ? "bg-zinc-700 text-zinc-400 cursor-not-allowed"
                         : "bg-gradient-to-r from-green-400 to-cyan-400 text-black hover:scale-[1.01]" }
                          `}
                        >
                      {isSubmitting ? "Analyzing Response..." : "Submit Answer"}
                    </button>
                  </div>
                </>
              ) : (
                <div className="mt-4">
                  <div className="rounded-[30px] bg-green-500/5 border border-green-500/20 p-7 mb-8">
                    ...
                    <p className="text-zinc-300 leading-8">{feedback}</p>
                  </div>

                  <button
                    onClick={handleFinishOrNext}
                    className=" w-full py-5 rounded-2xl bg-gradient-to-r from-green-400 to-cyan-400 text-black font-semibold text-lg "
                  >
        ...
        {submittedAnswer && (
          <div className="mt-12">
            <div className="rounded-[40px] bg-white/5 border border-white/10 backdrop-blur-2xl p-8 shadow-2xl">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-bold">Answer Comparison</h2>

                <div className="text-green-400">AI Evaluation Panel</div>
              </div>
