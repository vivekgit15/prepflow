    ...
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
        <div className='w-full max-w-6xl bg-white rounded[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
          ...
          <div className='flex items-center gap-3 cursor-pointer'>
            ...
            <h1 className='font-semibold hidde md:block text-lg'>PrepFlow</h1>
          </div>
            ...
            <div className='relative '>
              ...
              {showCreditPopup && (
                <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
                  ...
                  className='w-full bg-black text-white py-2 rounded-lg text-sm'>Buy more cedits</button>
                </div>
              )}
            </div>
    <div className='relative'>
          ...
          {showUserPopup && (
            <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
              ...
              className='w-full text-left text-sm py-2 flex items-center gap-2 text-red-500'>Logout</button>
              </div>
          )}
            </div>
          </div>
